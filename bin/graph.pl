...
$output = `rrdtool graph $graphdirectory/humidity${time}.png -a PNG -l 0 -y 5:1 --vertical-label "percent rh" -s -${time} -w 1024 -h 300 'DEF:boilerrm='$rrddirectory/boilerrmhum.rrd:hum:LAST 'DEF:cellar='$rrddirectory/cellarhum.rrd:hum:LAST 'DEF:office='$rrddirectory/officehum.rrd:hum:LAST 'DEF:coal='$rrddirectory/coalhum.rrd:hum:LAST 'DEF:outside='$rrddirectory/os1hum.rrd:hum:LAST 'LINE2:cellar#${col01}:cellar' 'LINE2:boilerrm#${col02}:boiler room' 'LINE2:office#${col03}:office' 'LINE2:coal#${col04}:coal cellar' 'LINE2:outside#${col12}:outside' `;
