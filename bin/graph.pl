...
$output = `rrdtool graph $graphdirectory/downstairsheat${time}.png -a PNG --vertical-label "deg c" -s -${time} -w 1024 -h 300 'DEF:zvflow='$rrddirectory/zvdownstairsflow.rrd:temp:LAST 'DEF:boilerreturn='$rrddirectory/boilerreturn.rrd:temp:LAST 'DEF:dbflow='$rrddirectory/dbathradflow.rrd:temp:LAST 'DEF:dbrtn='$rrddirectory/dbathradrtn.rrd:temp:LAST 'DEF:hall1flow='$rrddirectory/hall1flow.rrd:temp:LAST 'DEF:hall1rtn='$rrddirectory/hall1rtn.rrd:temp:LAST 'DEF:hall2flow='$rrddirectory/hall2flow.rrd:temp:LAST 'DEF:hall2rtn='$rrddirectory/hall2rtn.rrd:temp:LAST 'DEF:kitchen1flow='$rrddirectory/kitchen1flow.rrd:temp:LAST 'DEF:kitchen1rtn='$rrddirectory/kitchen1rtn.rrd:temp:LAST 'DEF:kitchen2flow='$rrddirectory/kitchen2flow.rrd:temp:LAST 'DEF:kitchen2rtn='$rrddirectory/kitchen2rtn.rrd:temp:LAST '${linetype}:zvflow#${col01}:zone valve' '${linetype}:boilerreturn#${col01}:boiler return:dashes=on' '${linetype}:dbflow#${col02}:bathroom towel rail' '${linetype}:dbrtn#${col02}:bathroom towel rail:dashes=on' '${linetype}:hall1flow#${col03}:hall radiator 1' '${linetype}:hall1rtn#${col03}:hall radiator 1:dashes=on' '${linetype}:hall2flow#${col04}:hall radiator 2' '${linetype}:hall2rtn#${col04}:hall radiator 2:dashes=on' '${linetype}:kitchen1flow#${col05}:kitchen radiator 1' '${linetype}:kitchen1rtn#${col05}:kitchen radiator 1:dashes=on' '${linetype}:kitchen2flow#${col06}:kitchen radiator 2' '${linetype}:kitchen2rtn#${col06}:kitchen radiator 2:dashes=on' -W "${datestamp}" -t "downstairs radiators"`;
