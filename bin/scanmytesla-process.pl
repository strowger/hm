...
#  never reads?
  ...
  if ( ! $inverterpcbrr eq "" ) { $influxcmdline .= "temp_inverterpcb_rear value=${inverterpcbrr} ${timestampline}000000\n"; print "inverterpcb rear $inverterpcbrr\n"; }

  # nonsense values spike graphs
  if ( ! $celltempmin eq "" ) { if ( $celltempmin > -50 ) { $influxcmdline .= "cell_temp_min value=${celltempmin} ${timestampline}000000\n"; } }
  ...
  # nonsense values spike graphs
  if ( ! $celltempdiff eq "" ) { if ( $celltempdiff < 50 ) { $influxcmdline .= "cell_temp_diff value=${celltempdiff} ${timestampline}000000\n"; } }

  if ( ! $celltemp01 eq "" ) { if ( $celltemp01 > -50 ) { $influxcmdline .= "cell_temp_01 value=${celltemp01} ${timestampline}000000\n"; } }
  if ( ! $celltemp02 eq "" ) { if ( $celltemp02 > -50 ) { $influxcmdline .= "cell_temp_02 value=${celltemp02} ${timestampline}000000\n"; } }
  if ( ! $celltemp03 eq "" ) { if ( $celltemp03 > -50 ) { $influxcmdline .= "cell_temp_03 value=${celltemp03} ${timestampline}000000\n"; } }
  if ( ! $celltemp04 eq "" ) { if ( $celltemp04 > -50 ) { $influxcmdline .= "cell_temp_04 value=${celltemp04} ${timestampline}000000\n"; } }
  if ( ! $celltemp05 eq "" ) { if ( $celltemp05 > -50 ) { $influxcmdline .= "cell_temp_05 value=${celltemp05} ${timestampline}000000\n"; } }
  if ( ! $celltemp06 eq "" ) { if ( $celltemp06 > -50 ) { $influxcmdline .= "cell_temp_06 value=${celltemp06} ${timestampline}000000\n"; } }
  if ( ! $celltemp07 eq "" ) { if ( $celltemp07 > -50 ) { $influxcmdline .= "cell_temp_07 value=${celltemp07} ${timestampline}000000\n"; } }
  if ( ! $celltemp08 eq "" ) { if ( $celltemp08 > -50 ) { $influxcmdline .= "cell_temp_08 value=${celltemp08} ${timestampline}000000\n"; } }
  if ( ! $celltemp09 eq "" ) { if ( $celltemp09 > -50 ) { $influxcmdline .= "cell_temp_09 value=${celltemp09} ${timestampline}000000\n"; } }
  if ( ! $celltemp10 eq "" ) { if ( $celltemp10 > -50 ) { $influxcmdline .= "cell_temp_10 value=${celltemp10} ${timestampline}000000\n"; } }
  if ( ! $celltemp11 eq "" ) { if ( $celltemp11 > -50 ) { $influxcmdline .= "cell_temp_11 value=${celltemp11} ${timestampline}000000\n"; } }
  if ( ! $celltemp12 eq "" ) { if ( $celltemp12 > -50 ) { $influxcmdline .= "cell_temp_12 value=${celltemp12} ${timestampline}000000\n"; } }
  if ( ! $celltemp13 eq "" ) { if ( $celltemp13 > -50 ) { $influxcmdline .= "cell_temp_13 value=${celltemp13} ${timestampline}000000\n"; } }
  if ( ! $celltemp14 eq "" ) { if ( $celltemp14 > -50 ) { $influxcmdline .= "cell_temp_14 value=${celltemp14} ${timestampline}000000\n"; } }
  if ( ! $celltemp15 eq "" ) { if ( $celltemp15 > -50 ) { $influxcmdline .= "cell_temp_15 value=${celltemp15} ${timestampline}000000\n"; } }
  if ( ! $celltemp16 eq "" ) { if ( $celltemp16 > -50 ) { $influxcmdline .= "cell_temp_16 value=${celltemp16} ${timestampline}000000\n"; } }
  if ( ! $celltemp17 eq "" ) { if ( $celltemp17 > -50 ) { $influxcmdline .= "cell_temp_17 value=${celltemp17} ${timestampline}000000\n"; } }
  if ( ! $celltemp18 eq "" ) { if ( $celltemp18 > -50 ) { $influxcmdline .= "cell_temp_18 value=${celltemp18} ${timestampline}000000\n"; } }
  if ( ! $celltemp19 eq "" ) { if ( $celltemp19 > -50 ) { $influxcmdline .= "cell_temp_19 value=${celltemp19} ${timestampline}000000\n"; } }
  if ( ! $celltemp20 eq "" ) { if ( $celltemp20 > -50 ) { $influxcmdline .= "cell_temp_20 value=${celltemp20} ${timestampline}000000\n"; } }
  if ( ! $celltemp21 eq "" ) { if ( $celltemp21 > -50 ) { $influxcmdline .= "cell_temp_21 value=${celltemp21} ${timestampline}000000\n"; } }
  if ( ! $celltemp22 eq "" ) { if ( $celltemp22 > -50 ) { $influxcmdline .= "cell_temp_22 value=${celltemp22} ${timestampline}000000\n"; } }
  if ( ! $celltemp23 eq "" ) { if ( $celltemp23 > -50 ) { $influxcmdline .= "cell_temp_23 value=${celltemp23} ${timestampline}000000\n"; } }
  if ( ! $celltemp24 eq "" ) { if ( $celltemp24 > -50 ) { $influxcmdline .= "cell_temp_24 value=${celltemp24} ${timestampline}000000\n"; } }
  if ( ! $celltemp25 eq "" ) { if ( $celltemp25 > -50 ) { $influxcmdline .= "cell_temp_25 value=${celltemp25} ${timestampline}000000\n"; } }
  if ( ! $celltemp26 eq "" ) { if ( $celltemp26 > -50 ) { $influxcmdline .= "cell_temp_26 value=${celltemp26} ${timestampline}000000\n"; } }
  if ( ! $celltemp27 eq "" ) { if ( $celltemp27 > -50 ) { $influxcmdline .= "cell_temp_27 value=${celltemp27} ${timestampline}000000\n"; } }
  if ( ! $celltemp28 eq "" ) { if ( $celltemp28 > -50 ) { $influxcmdline .= "cell_temp_28 value=${celltemp28} ${timestampline}000000\n"; } }
  if ( ! $celltemp29 eq "" ) { if ( $celltemp29 > -50 ) { $influxcmdline .= "cell_temp_29 value=${celltemp29} ${timestampline}000000\n"; } }
  if ( ! $celltemp30 eq "" ) { if ( $celltemp30 > -50 ) { $influxcmdline .= "cell_temp_30 value=${celltemp30} ${timestampline}000000\n"; } }
  if ( ! $celltemp31 eq "" ) { if ( $celltemp31 > -50 ) { $influxcmdline .= "cell_temp_31 value=${celltemp31} ${timestampline}000000\n"; } }
  if ( ! $celltemp32 eq "" ) { if ( $celltemp32 > -50 ) { $influxcmdline .= "cell_temp_32 value=${celltemp32} ${timestampline}000000\n"; } }

  if ( ! $cellvolts01 eq "" ) { $influxcmdlinevolts .= "cell_volts_01 value=${cellvolts01} ${timestampline}000000\n"; }
  if ( ! $cellvolts02 eq "" ) { $influxcmdlinevolts .= "cell_volts_02 value=${cellvolts02} ${timestampline}000000\n"; }
  if ( ! $cellvolts03 eq "" ) { $influxcmdlinevolts .= "cell_volts_03 value=${cellvolts03} ${timestampline}000000\n"; }
  if ( ! $cellvolts04 eq "" ) { $influxcmdlinevolts .= "cell_volts_04 value=${cellvolts04} ${timestampline}000000\n"; }
  if ( ! $cellvolts05 eq "" ) { $influxcmdlinevolts .= "cell_volts_05 value=${cellvolts05} ${timestampline}000000\n"; }
  if ( ! $cellvolts06 eq "" ) { $influxcmdlinevolts .= "cell_volts_06 value=${cellvolts06} ${timestampline}000000\n"; }
  if ( ! $cellvolts07 eq "" ) { $influxcmdlinevolts .= "cell_volts_07 value=${cellvolts07} ${timestampline}000000\n"; }
  if ( ! $cellvolts08 eq "" ) { $influxcmdlinevolts .= "cell_volts_08 value=${cellvolts08} ${timestampline}000000\n"; }
  if ( ! $cellvolts09 eq "" ) { $influxcmdlinevolts .= "cell_volts_09 value=${cellvolts09} ${timestampline}000000\n"; }
  if ( ! $cellvolts10 eq "" ) { $influxcmdlinevolts .= "cell_volts_10 value=${cellvolts10} ${timestampline}000000\n"; }
  if ( ! $cellvolts11 eq "" ) { $influxcmdlinevolts .= "cell_volts_11 value=${cellvolts11} ${timestampline}000000\n"; }
  if ( ! $cellvolts12 eq "" ) { $influxcmdlinevolts .= "cell_volts_12 value=${cellvolts12} ${timestampline}000000\n"; }
  if ( ! $cellvolts13 eq "" ) { $influxcmdlinevolts .= "cell_volts_13 value=${cellvolts13} ${timestampline}000000\n"; }
  if ( ! $cellvolts14 eq "" ) { $influxcmdlinevolts .= "cell_volts_14 value=${cellvolts14} ${timestampline}000000\n"; }
  if ( ! $cellvolts15 eq "" ) { $influxcmdlinevolts .= "cell_volts_15 value=${cellvolts15} ${timestampline}000000\n"; }
  if ( ! $cellvolts16 eq "" ) { $influxcmdlinevolts .= "cell_volts_16 value=${cellvolts16} ${timestampline}000000\n"; }
  if ( ! $cellvolts17 eq "" ) { $influxcmdlinevolts .= "cell_volts_17 value=${cellvolts17} ${timestampline}000000\n"; }
  if ( ! $cellvolts18 eq "" ) { $influxcmdlinevolts .= "cell_volts_18 value=${cellvolts18} ${timestampline}000000\n"; }
  if ( ! $cellvolts19 eq "" ) { $influxcmdlinevolts .= "cell_volts_19 value=${cellvolts19} ${timestampline}000000\n"; }
  if ( ! $cellvolts20 eq "" ) { $influxcmdlinevolts .= "cell_volts_20 value=${cellvolts20} ${timestampline}000000\n"; }
  if ( ! $cellvolts21 eq "" ) { $influxcmdlinevolts .= "cell_volts_21 value=${cellvolts21} ${timestampline}000000\n"; }
  if ( ! $cellvolts22 eq "" ) { $influxcmdlinevolts .= "cell_volts_22 value=${cellvolts22} ${timestampline}000000\n"; }
  if ( ! $cellvolts23 eq "" ) { $influxcmdlinevolts .= "cell_volts_23 value=${cellvolts23} ${timestampline}000000\n"; }
  if ( ! $cellvolts24 eq "" ) { $influxcmdlinevolts .= "cell_volts_24 value=${cellvolts24} ${timestampline}000000\n"; }
  if ( ! $cellvolts25 eq "" ) { $influxcmdlinevolts .= "cell_volts_25 value=${cellvolts25} ${timestampline}000000\n"; }
  if ( ! $cellvolts26 eq "" ) { $influxcmdlinevolts .= "cell_volts_26 value=${cellvolts26} ${timestampline}000000\n"; }
  if ( ! $cellvolts27 eq "" ) { $influxcmdlinevolts .= "cell_volts_27 value=${cellvolts27} ${timestampline}000000\n"; }
  if ( ! $cellvolts28 eq "" ) { $influxcmdlinevolts .= "cell_volts_28 value=${cellvolts28} ${timestampline}000000\n"; }
  if ( ! $cellvolts29 eq "" ) { $influxcmdlinevolts .= "cell_volts_29 value=${cellvolts29} ${timestampline}000000\n"; }
  if ( ! $cellvolts30 eq "" ) { $influxcmdlinevolts .= "cell_volts_30 value=${cellvolts30} ${timestampline}000000\n"; }
  if ( ! $cellvolts31 eq "" ) { $influxcmdlinevolts .= "cell_volts_31 value=${cellvolts31} ${timestampline}000000\n"; }
  if ( ! $cellvolts32 eq "" ) { $influxcmdlinevolts .= "cell_volts_32 value=${cellvolts32} ${timestampline}000000\n"; }
  if ( ! $cellvolts33 eq "" ) { $influxcmdlinevolts .= "cell_volts_33 value=${cellvolts33} ${timestampline}000000\n"; }
  if ( ! $cellvolts34 eq "" ) { $influxcmdlinevolts .= "cell_volts_34 value=${cellvolts34} ${timestampline}000000\n"; }
  if ( ! $cellvolts35 eq "" ) { $influxcmdlinevolts .= "cell_volts_35 value=${cellvolts35} ${timestampline}000000\n"; }
  if ( ! $cellvolts36 eq "" ) { $influxcmdlinevolts .= "cell_volts_36 value=${cellvolts36} ${timestampline}000000\n"; }
  if ( ! $cellvolts37 eq "" ) { $influxcmdlinevolts .= "cell_volts_37 value=${cellvolts37} ${timestampline}000000\n"; }
  if ( ! $cellvolts38 eq "" ) { $influxcmdlinevolts .= "cell_volts_38 value=${cellvolts38} ${timestampline}000000\n"; }
  if ( ! $cellvolts39 eq "" ) { $influxcmdlinevolts .= "cell_volts_39 value=${cellvolts39} ${timestampline}000000\n"; }
  if ( ! $cellvolts40 eq "" ) { $influxcmdlinevolts .= "cell_volts_40 value=${cellvolts40} ${timestampline}000000\n"; }
  if ( ! $cellvolts41 eq "" ) { $influxcmdlinevolts .= "cell_volts_41 value=${cellvolts41} ${timestampline}000000\n"; }
  if ( ! $cellvolts42 eq "" ) { $influxcmdlinevolts .= "cell_volts_42 value=${cellvolts42} ${timestampline}000000\n"; }
  if ( ! $cellvolts43 eq "" ) { $influxcmdlinevolts .= "cell_volts_43 value=${cellvolts43} ${timestampline}000000\n"; }
  if ( ! $cellvolts44 eq "" ) { $influxcmdlinevolts .= "cell_volts_44 value=${cellvolts44} ${timestampline}000000\n"; }
  if ( ! $cellvolts45 eq "" ) { $influxcmdlinevolts .= "cell_volts_45 value=${cellvolts45} ${timestampline}000000\n"; }
  if ( ! $cellvolts46 eq "" ) { $influxcmdlinevolts .= "cell_volts_46 value=${cellvolts46} ${timestampline}000000\n"; }
  if ( ! $cellvolts47 eq "" ) { $influxcmdlinevolts .= "cell_volts_47 value=${cellvolts47} ${timestampline}000000\n"; }
  if ( ! $cellvolts48 eq "" ) { $influxcmdlinevolts .= "cell_volts_48 value=${cellvolts48} ${timestampline}000000\n"; }
  if ( ! $cellvolts49 eq "" ) { $influxcmdlinevolts .= "cell_volts_49 value=${cellvolts49} ${timestampline}000000\n"; }
  if ( ! $cellvolts50 eq "" ) { $influxcmdlinevolts .= "cell_volts_50 value=${cellvolts50} ${timestampline}000000\n"; }
  if ( ! $cellvolts51 eq "" ) { $influxcmdlinevolts .= "cell_volts_51 value=${cellvolts51} ${timestampline}000000\n"; }
  if ( ! $cellvolts52 eq "" ) { $influxcmdlinevolts .= "cell_volts_52 value=${cellvolts52} ${timestampline}000000\n"; }
  if ( ! $cellvolts53 eq "" ) { $influxcmdlinevolts .= "cell_volts_53 value=${cellvolts53} ${timestampline}000000\n"; }
  if ( ! $cellvolts54 eq "" ) { $influxcmdlinevolts .= "cell_volts_54 value=${cellvolts54} ${timestampline}000000\n"; }
  if ( ! $cellvolts55 eq "" ) { $influxcmdlinevolts .= "cell_volts_55 value=${cellvolts55} ${timestampline}000000\n"; }
  if ( ! $cellvolts56 eq "" ) { $influxcmdlinevolts .= "cell_volts_56 value=${cellvolts56} ${timestampline}000000\n"; }
  if ( ! $cellvolts57 eq "" ) { $influxcmdlinevolts .= "cell_volts_57 value=${cellvolts57} ${timestampline}000000\n"; }
  if ( ! $cellvolts58 eq "" ) { $influxcmdlinevolts .= "cell_volts_58 value=${cellvolts58} ${timestampline}000000\n"; }
  if ( ! $cellvolts59 eq "" ) { $influxcmdlinevolts .= "cell_volts_59 value=${cellvolts59} ${timestampline}000000\n"; }
  if ( ! $cellvolts60 eq "" ) { $influxcmdlinevolts .= "cell_volts_60 value=${cellvolts60} ${timestampline}000000\n"; }
  if ( ! $cellvolts61 eq "" ) { $influxcmdlinevolts .= "cell_volts_61 value=${cellvolts61} ${timestampline}000000\n"; }
  if ( ! $cellvolts62 eq "" ) { $influxcmdlinevolts .= "cell_volts_62 value=${cellvolts62} ${timestampline}000000\n"; }
  if ( ! $cellvolts63 eq "" ) { $influxcmdlinevolts .= "cell_volts_63 value=${cellvolts63} ${timestampline}000000\n"; }
  if ( ! $cellvolts64 eq "" ) { $influxcmdlinevolts .= "cell_volts_64 value=${cellvolts64} ${timestampline}000000\n"; }
  if ( ! $cellvolts65 eq "" ) { $influxcmdlinevolts .= "cell_volts_65 value=${cellvolts65} ${timestampline}000000\n"; }
  if ( ! $cellvolts66 eq "" ) { $influxcmdlinevolts .= "cell_volts_66 value=${cellvolts66} ${timestampline}000000\n"; }
  if ( ! $cellvolts67 eq "" ) { $influxcmdlinevolts .= "cell_volts_67 value=${cellvolts67} ${timestampline}000000\n"; }
  if ( ! $cellvolts68 eq "" ) { $influxcmdlinevolts .= "cell_volts_68 value=${cellvolts68} ${timestampline}000000\n"; }
  if ( ! $cellvolts69 eq "" ) { $influxcmdlinevolts .= "cell_volts_69 value=${cellvolts69} ${timestampline}000000\n"; }
  if ( ! $cellvolts70 eq "" ) { $influxcmdlinevolts .= "cell_volts_70 value=${cellvolts70} ${timestampline}000000\n"; }
  if ( ! $cellvolts71 eq "" ) { $influxcmdlinevolts .= "cell_volts_71 value=${cellvolts71} ${timestampline}000000\n"; }
  if ( ! $cellvolts72 eq "" ) { $influxcmdlinevolts .= "cell_volts_72 value=${cellvolts72} ${timestampline}000000\n"; }
  if ( ! $cellvolts73 eq "" ) { $influxcmdlinevolts .= "cell_volts_73 value=${cellvolts73} ${timestampline}000000\n"; }
  if ( ! $cellvolts74 eq "" ) { $influxcmdlinevolts .= "cell_volts_74 value=${cellvolts74} ${timestampline}000000\n"; }
  if ( ! $cellvolts75 eq "" ) { $influxcmdlinevolts .= "cell_volts_75 value=${cellvolts75} ${timestampline}000000\n"; }
  if ( ! $cellvolts76 eq "" ) { $influxcmdlinevolts .= "cell_volts_76 value=${cellvolts76} ${timestampline}000000\n"; }
  if ( ! $cellvolts77 eq "" ) { $influxcmdlinevolts .= "cell_volts_77 value=${cellvolts77} ${timestampline}000000\n"; }
  if ( ! $cellvolts78 eq "" ) { $influxcmdlinevolts .= "cell_volts_78 value=${cellvolts78} ${timestampline}000000\n"; }
  if ( ! $cellvolts79 eq "" ) { $influxcmdlinevolts .= "cell_volts_79 value=${cellvolts79} ${timestampline}000000\n"; }
  if ( ! $cellvolts80 eq "" ) { $influxcmdlinevolts .= "cell_volts_80 value=${cellvolts80} ${timestampline}000000\n"; }
  if ( ! $cellvolts81 eq "" ) { $influxcmdlinevolts .= "cell_volts_81 value=${cellvolts81} ${timestampline}000000\n"; }
  if ( ! $cellvolts82 eq "" ) { $influxcmdlinevolts .= "cell_volts_82 value=${cellvolts82} ${timestampline}000000\n"; }
  if ( ! $cellvolts83 eq "" ) { $influxcmdlinevolts .= "cell_volts_83 value=${cellvolts83} ${timestampline}000000\n"; }
  if ( ! $cellvolts84 eq "" ) { $influxcmdlinevolts .= "cell_volts_84 value=${cellvolts84} ${timestampline}000000\n"; }
  if ( ! $cellvolts85 eq "" ) { $influxcmdlinevolts .= "cell_volts_85 value=${cellvolts85} ${timestampline}000000\n"; }
  if ( ! $cellvolts86 eq "" ) { $influxcmdlinevolts .= "cell_volts_86 value=${cellvolts86} ${timestampline}000000\n"; }
  if ( ! $cellvolts87 eq "" ) { $influxcmdlinevolts .= "cell_volts_87 value=${cellvolts87} ${timestampline}000000\n"; }
  if ( ! $cellvolts88 eq "" ) { $influxcmdlinevolts .= "cell_volts_88 value=${cellvolts88} ${timestampline}000000\n"; }
  if ( ! $cellvolts89 eq "" ) { $influxcmdlinevolts .= "cell_volts_89 value=${cellvolts89} ${timestampline}000000\n"; }
  if ( ! $cellvolts90 eq "" ) { $influxcmdlinevolts .= "cell_volts_90 value=${cellvolts90} ${timestampline}000000\n"; }
  if ( ! $cellvolts91 eq "" ) { $influxcmdlinevolts .= "cell_volts_91 value=${cellvolts91} ${timestampline}000000\n"; }
  if ( ! $cellvolts92 eq "" ) { $influxcmdlinevolts .= "cell_volts_92 value=${cellvolts92} ${timestampline}000000\n"; }
  if ( ! $cellvolts93 eq "" ) { $influxcmdlinevolts .= "cell_volts_93 value=${cellvolts93} ${timestampline}000000\n"; }
  if ( ! $cellvolts94 eq "" ) { $influxcmdlinevolts .= "cell_volts_94 value=${cellvolts94} ${timestampline}000000\n"; }
  if ( ! $cellvolts95 eq "" ) { $influxcmdlinevolts .= "cell_volts_95 value=${cellvolts95} ${timestampline}000000\n"; }
  if ( ! $cellvolts96 eq "" ) { $influxcmdlinevolts .= "cell_volts_96 value=${cellvolts96} ${timestampline}000000\n"; }
...
##    print "$result \n";
  ...
  if (length($influxcmdlinevolts) > 20000)
  {
