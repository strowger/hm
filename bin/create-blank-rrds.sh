...
# 20170606 currentcost counters - enabled by euan's rtl433 mods 
# NB these are COUNTER not GAUGE !!

rrdtool create cccountoptical.rrd --start 1496760000 --step 60 \
DS:power:COUNTER:120:0:10000 \
RRA:LAST:0.5:1:15811200 \
RRA:AVERAGE:0.1:1440:10980 \
RRA:AVERAGE:0.1:10080:1569 \
RRA:AVERAGE:0.1:40320:393 \
...
rrdtool create cccountgas.rrd --start 1496760000 --step 60 \
DS:power:COUNTER:120:0:10000 \
RRA:LAST:0.5:1:15811200 \
RRA:AVERAGE:0.1:1440:10980 \
RRA:AVERAGE:0.1:10080:1569 \
